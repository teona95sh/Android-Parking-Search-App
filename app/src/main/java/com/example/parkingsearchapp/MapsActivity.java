...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        marker = mMap.addMarker(new MarkerOptions().position(israel).title("").draggable(true));
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                showReportsOnMap(reportsUserData);
            }
    ...
    private void showReportsOnMap(List<Reports> reportsUserData) {
        for (Reports report : reportsUserData) {
            try {
                LatLng latLng = new LatLng(Double.parseDouble(report.latitude), Double.parseDouble(report.longitude));
                MarkerOptions markerOptions = new MarkerOptions();
                markerOptions.position(latLng);
                markerOptions.title(report.address);
    ...
    public boolean onMarkerClick(@NonNull Marker marker) {
        ...
        builder.setMessage(marker.getSnippet()).setTitle(marker.toString()).setCancelable(true);
